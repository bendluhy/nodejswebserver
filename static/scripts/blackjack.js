...
Card.prototype.getImageUrl = function(){
    ...
    return '<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1151732/' + sundry + '_' + this.suit + '.png">';
};
...
function deal() {
    ...
    deck.draw('player');
    deck.draw('dealer');
    $('#dealer-hand :first-child').attr('src', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/1151732/card.png');
    deck.draw('player');
    deck.draw('dealer');
...
function hit() {
    ...
    // Player busts or gets blackjack
...
function flipHoleCard() {
    ...
    var holeCardSrc = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/1151732/' + sundry + '_' + holeCard.suit + '.png';
...
function outOfChips(){
    swal({
      ...
      imageUrl: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1151732/chip-2.png"
    },
      function(isConfirm){
        if (isConfirm) {
          bets = new Bets();
...
function welcome() {
  swal({
    ...
    imageUrl: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1151732/chip.png"
  });
}
